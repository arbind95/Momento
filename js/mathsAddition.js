/*
  This function creates menu for the Addition category of the Maths level.
...
*/
function createAdditionMenu(){
  document.body.innerHTML="";
  createImage("images/background/background.png","bgImg1");
  createHeading1("Addition");
  //Button for creating the play scene of Addition category in Maths level by calling playAddition() function when clicked
  var playButton= createButton("Play");
  playButton.onclick= playAddition;

  //Button for displaying information on how to play Addition category in Maths level by calling AdditionInfo() function when clicked
  var infoButton=createButton("Information");
  infoButton.onclick= AdditionInfo;

  //Button for going back to the menu in Maths level by calling createDeepMenu() function when clicked
  var BackButton= createButton("Back");
  BackButton.onclick= createMathsMenu;
}

/*
  This function creates information page for the Addition category of the Maths level.
...
function AdditionInfo(){
  ...
  var BackButton= createButton("Back");
  BackButton.onclick= createAdditionMenu;
}

/*
  This function creates the playing scene for the Addition category of the Maths level.
...
function playAddition(){
  ...
  img[0].onclick = createChangingImage(0,maths_addition[0].url);
  img[1].onclick = createChangingImage(1,maths_addition[1].url);
  img[2].onclick = createChangingImage(2,maths_addition[2].url);
  img[3].onclick = createChangingImage(3,maths_addition[3].url);
  img[4].onclick = createChangingImage(4,maths_addition[4].url);
  img[5].onclick = createChangingImage(5,maths_addition[5].url);
  img[6].onclick = createChangingImage(6,maths_addition[6].url);
  img[7].onclick = createChangingImage(7,maths_addition[7].url);
  img[8].onclick = createChangingImage(8,maths_addition[8].url);
  img[9].onclick = createChangingImage(9,maths_addition[9].url);
  img[10].onclick = createChangingImage(10,maths_addition[10].url);
  img[11].onclick = createChangingImage(11,maths_addition[11].url);
  ...
  */
  ...
  function changeImage (val, url){
    ...
    if((clickInformation[0] != undefined) && (clickInformation[1] == undefined)) {
      clickInformation[1]= maths_addition[val].name;
    }
    if((clickInformation[0] == undefined) && (clickInformation[1] == undefined)){
      clickInformation[0]= maths_addition[val].name;
    }
    ...
    if((clickInformation[0]!= undefined) && (clickInformation[1]!= undefined)){
      ...
      //if no match has been detected then changing both the images back to the theme image
          ...
          img[imageDivisionValues[0]].onclick = createChangingImage(imageDivisionValues[0],maths_addition[imageDivisionValues[0]].url);
          ...
          img[imageDivisionValues[1]].onclick = createChangingImage(imageDivisionValues[1],maths_addition[imageDivisionValues[1]].url);
