/*
  This function creates menu for the Multiplication category of the Maths level.
...
*/
function createMultiplicationMenu(){
  document.body.innerHTML="";
  createImage("images/background/background.png","bgImg1");
  createHeading1("Multiplication");
  ...
  playButton.onclick= playMultiplication;
  ...
  infoButton.onclick= MultiplicationInfo;
...
function MultiplicationInfo(){
  ...
  var BackButton= createButton("Back");
  BackButton.onclick= createMultiplicationMenu;
}

/*
  This function creates the playing scene for the Multiplication category of the Maths level.
...
function playMultiplication(){
  ...
  img[0].onclick = createChangingImage(0,maths_multiplication[0].url);
  img[1].onclick = createChangingImage(1,maths_multiplication[1].url);
  img[2].onclick = createChangingImage(2,maths_multiplication[2].url);
  img[3].onclick = createChangingImage(3,maths_multiplication[3].url);
  img[4].onclick = createChangingImage(4,maths_multiplication[4].url);
  img[5].onclick = createChangingImage(5,maths_multiplication[5].url);
  img[6].onclick = createChangingImage(6,maths_multiplication[6].url);
  img[7].onclick = createChangingImage(7,maths_multiplication[7].url);
  img[8].onclick = createChangingImage(8,maths_multiplication[8].url);
  img[9].onclick = createChangingImage(9,maths_multiplication[9].url);
  img[10].onclick = createChangingImage(10,maths_multiplication[10].url);
  img[11].onclick = createChangingImage(11,maths_multiplication[11].url);
  ...
  */
  ...
  function changeImage (val, url){
    ...
    if((clickInformation[0] != undefined) && (clickInformation[1] == undefined)) {
      clickInformation[1]= maths_multiplication[val].name;
    }
    if((clickInformation[0] == undefined) && (clickInformation[1] == undefined)){
      clickInformation[0]= maths_multiplication[val].name;
    }
    ...
    if((clickInformation[0]!= undefined) && (clickInformation[1]!= undefined)){
      ...
      //if no match has been detected then changing both the images back to the theme image
          ...
          img[imageDivisionValues[0]].onclick = createChangingImage(imageDivisionValues[0],maths_multiplication[imageDivisionValues[0]].url);
          ...
          img[imageDivisionValues[1]].onclick = createChangingImage(imageDivisionValues[1],maths_multiplication[imageDivisionValues[1]].url);
