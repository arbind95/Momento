/*
  This function creates menu for the Personalities category of the Deep level.
...
*/
function createDeepPersonalitiesMenu(){
  document.body.innerHTML="";
  createImage("images/background/background.png","bgImg1");
  createHeading1("Deep-Personalities");
  //Button for creating the play scene of Personalities category in Deep level by calling playDeepPersonalitiesMenu() function when clicked
  var playButton= createButton("Play");
  playButton.onclick= playDeepPersonalities;

  //Button for displaying information on how to play Personalities category in Deep level by calling deepPersonalitiesInfo() function when clicked
  var infoButton=createButton("Information");
  infoButton.onclick= deepPersonalitiesInfo;
...
function deepPersonalitiesInfo(){
  ...
  var BackButton= createButton("Back");
  BackButton.onclick= createDeepPersonalitiesMenu;
}

/*
  This function creates the playing scene for the Personalities category of the Deep level.
  ...
  This function does not accept any parameters and does not have any return values.
*/
function playDeepPersonalities(){
  document.body.innerHTML="";
  if(audioControl == "ON"){
  ...
  img[0].onclick = createChangingImage(0,deep_personalities[0].url);
  img[1].onclick = createChangingImage(1,deep_personalities[1].url);
  img[2].onclick = createChangingImage(2,deep_personalities[2].url);
  img[3].onclick = createChangingImage(3,deep_personalities[3].url);
  img[4].onclick = createChangingImage(4,deep_personalities[4].url);
  img[5].onclick = createChangingImage(5,deep_personalities[5].url);
  img[6].onclick = createChangingImage(6,deep_personalities[6].url);
  img[7].onclick = createChangingImage(7,deep_personalities[7].url);
  img[8].onclick = createChangingImage(8,deep_personalities[8].url);
  img[9].onclick = createChangingImage(9,deep_personalities[9].url);
  img[10].onclick = createChangingImage(10,deep_personalities[10].url);
  img[11].onclick = createChangingImage(11,deep_personalities[11].url);
  ...
  */
  ...
  function changeImage (val, url){
    ...
    if((clickInformation[0] != undefined) && (clickInformation[1] == undefined)) {
      clickInformation[1]= deep_personalities[val].name;
    }
    if((clickInformation[0] == undefined) && (clickInformation[1] == undefined)){
      clickInformation[0]=deep_personalities[val].name;
    }
    ...
    if((clickInformation[0]!= undefined) && (clickInformation[1]!= undefined)){
      ...
      if ( (clickInformation[0]=="AbrahamLincoln" && clickInformation[1]=="AbrahamLincolnName") || (clickInformation[0]=="AbrahamLincolnName" && clickInformation[1]=="AbrahamLincoln")){
      ...
      else if ( (clickInformation[0]=="AdolfHitler" && clickInformation[1]=="AdolfHitlerName") || (clickInformation[0]=="AdolfHitlerName" && clickInformation[1]=="AdolfHitler")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="CheGuevara" && clickInformation[1]=="CheGuevaraName") || (clickInformation[0]=="CheGuevaraName" && clickInformation[1]=="CheGuevara")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="MahatmaGandhi" && clickInformation[1]=="MahatmaGandhiName") || (clickInformation[0]=="MahatmaGandhiName" && clickInformation[1]=="MahatmaGandhi")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="NelsonMandela" && clickInformation[1]=="NelsonMandelaName") || (clickInformation[0]=="NelsonMandelaName" && clickInformation[1]=="NelsonMandela")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="QueenVictoria" && clickInformation[1]=="QueenVictoriaName") || (clickInformation[0]=="QueenVictoriaName" && clickInformation[1]=="QueenVictoria")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      //if no match has been detected then changing both the images back to the theme image
          ...
          img[imageDivisionValues[0]].onclick = createChangingImage(imageDivisionValues[0],deep_personalities[imageDivisionValues[0]].url);
          ...
          img[imageDivisionValues[1]].onclick = createChangingImage(imageDivisionValues[1],deep_personalities[imageDivisionValues[1]].url);
