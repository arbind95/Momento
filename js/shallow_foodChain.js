/*
  This function creates menu for the Food Chain category of the Shallow level.
...
*/
function createShallowFoodchainMenu(){
  document.body.innerHTML="";
  createImage("images/background/background.png","bgImg1");
  createHeading1("Shallow- Food Chain");
  //Button for creating the play scene of Food Chain category in Shallow level by calling playFoodChain() function when clicked
  var playButton= createButton("Play");
  playButton.onclick= playFoodChain;

  //Button for displaying information on how to play Food Chain category in Shallow level by calling shallowFoodchainInfo() function when clicked
  var infoButton=createButton("Information");
  infoButton.onclick= shallowFoodchainInfo;
...
function playFoodChain(){
  ...
  img[0].onclick = createChangingImage(0,shallow_foodchain[0].url);
  img[1].onclick = createChangingImage(1,shallow_foodchain[1].url);
  img[2].onclick = createChangingImage(2,shallow_foodchain[2].url);
  img[3].onclick = createChangingImage(3,shallow_foodchain[3].url);
  img[4].onclick = createChangingImage(4,shallow_foodchain[4].url);
  img[5].onclick = createChangingImage(5,shallow_foodchain[5].url);
  img[6].onclick = createChangingImage(6,shallow_foodchain[6].url);
  img[7].onclick = createChangingImage(7,shallow_foodchain[7].url);
  img[8].onclick = createChangingImage(8,shallow_foodchain[8].url);
  img[9].onclick = createChangingImage(9,shallow_foodchain[9].url);
  img[10].onclick = createChangingImage(10,shallow_foodchain[10].url);
  img[11].onclick = createChangingImage(11,shallow_foodchain[11].url);
  /*
  ...
  */
  function changeImage (val, url){
    ...
    if((clickInformation[0] != undefined) && (clickInformation[1] == undefined)) {
      clickInformation[1]= shallow_foodchain[val].name;
    }
    if((clickInformation[0] == undefined) && (clickInformation[1] == undefined)){
      clickInformation[0]=shallow_foodchain[val].name;
    }
    ...
    if((clickInformation[0]!= undefined) && (clickInformation[1]!= undefined)){
      ...
      if ( (clickInformation[0]=="deer" && clickInformation[1]=="grass") || (clickInformation[0]=="grass" && clickInformation[1]=="deer")){
      ...
      else if ( (clickInformation[0]=="mouse" && clickInformation[1]=="snake") || (clickInformation[0]=="snake" && clickInformation[1]=="mouse")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="panda" && clickInformation[1]=="bamboo") || (clickInformation[0]=="bamboo" && clickInformation[1]=="panda")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="lion" && clickInformation[1]=="meat") || (clickInformation[0]=="meat" && clickInformation[1]=="lion")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="duck" && clickInformation[1]=="shell") || (clickInformation[0]=="shell" && clickInformation[1]=="duck")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="bear" && clickInformation[1]=="fish") || (clickInformation[0]=="fish" && clickInformation[1]=="bear")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      //if no match has been detected then changing both the images back to the theme image
          ...
          img[imageDivisionValues[0]].onclick = createChangingImage(imageDivisionValues[0],shallow_foodchain[imageDivisionValues[0]].url);
          ...
          img[imageDivisionValues[1]].onclick = createChangingImage(imageDivisionValues[1],shallow_foodchain[imageDivisionValues[1]].url);
