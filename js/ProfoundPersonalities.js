/*
  This function creates menu for the Personalities category of the Profound level.
...
*/
function createProfoundPersonalitiesMenu(){
  document.body.innerHTML="";
  createImage("images/background/background.png","bgImg1");
  createHeading1("Profound-Personalities");
  //Button for creating the play scene of Personalities category in Profound level by calling playProfoundPersonalitiesMenu() function when clicked
  var playButton= createButton("Play");
  playButton.onclick= playProfoundPersonalities;

  //Button for displaying information on how to play Personalities category in Profound level by calling profoundPersonalitiesInfo() function when clicked
  var infoButton=createButton("Information");
  infoButton.onclick= profoundPersonalitiesInfo;
...
function profoundPersonalitiesInfo(){
  ...
  var BackButton= createButton("Back");
  BackButton.onclick= createProfoundPersonalitiesMenu;
}

/*
  This function creates the playing scene for the Personalities category of the Profound level.
  ...
  This function does not accept any parameters and does not have any return values.
*/
function playProfoundPersonalities(){
  document.body.innerHTML="";
  if(audioControl == "ON"){
  ...
  img[0].onclick = createChangingImage(0,profound_personalities[0].url);
  img[1].onclick = createChangingImage(1,profound_personalities[1].url);
  img[2].onclick = createChangingImage(2,profound_personalities[2].url);
  img[3].onclick = createChangingImage(3,profound_personalities[3].url);
  img[4].onclick = createChangingImage(4,profound_personalities[4].url);
  img[5].onclick = createChangingImage(5,profound_personalities[5].url);
  img[6].onclick = createChangingImage(6,profound_personalities[6].url);
  img[7].onclick = createChangingImage(7,profound_personalities[7].url);
  img[8].onclick = createChangingImage(8,profound_personalities[8].url);
  img[9].onclick = createChangingImage(9,profound_personalities[9].url);
  img[10].onclick = createChangingImage(10,profound_personalities[10].url);
  img[11].onclick = createChangingImage(11,profound_personalities[11].url);
  ...
  */
  function changeImage (val, url){
    ...
    if((clickInformation[0] != undefined) && (clickInformation[1] == undefined)) {
      clickInformation[1]= profound_personalities[val].name;
    }
    if((clickInformation[0] == undefined) && (clickInformation[1] == undefined)){
      clickInformation[0]=profound_personalities[val].name;
    }
    ...
    if((clickInformation[0]!= undefined) && (clickInformation[1]!= undefined)){
      ...
      if ( (clickInformation[0]=="AbrahamLincoln" && clickInformation[1]=="USA") || (clickInformation[0]=="USA" && clickInformation[1]=="AbrahamLincoln")){
        score++;
      ...
      else if ( (clickInformation[0]=="AdolfHitler" && clickInformation[1]=="Germany") || (clickInformation[0]=="Germany" && clickInformation[1]=="AdolfHitler")){
      ...
      else if ( (clickInformation[0]=="CheGuevara" && clickInformation[1]=="Argentina") || (clickInformation[0]=="Argentina" && clickInformation[1]=="CheGuevara")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="MahatmaGandhi" && clickInformation[1]=="India") || (clickInformation[0]=="India" && clickInformation[1]=="MahatmaGandhi")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="NelsonMandela" && clickInformation[1]=="SouthAfrica") || (clickInformation[0]=="SouthAfrica" && clickInformation[1]=="NelsonMandela")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      else if ( (clickInformation[0]=="QueenVictoria" && clickInformation[1]=="UK") || (clickInformation[0]=="UK" && clickInformation[1]=="QueenVictoria")){
        score++;
        scoreDivision.removeChild(scoreText);
        scoreText = document.createTextNode("Current Score: "+score);
        scoreDivision.appendChild(scoreText);
      ...
      //if no match has been detected then changing both the images back to the theme image
          ...
          img[imageDivisionValues[0]].onclick = createChangingImage(imageDivisionValues[0],profound_personalities[imageDivisionValues[0]].url);
          ...
          img[imageDivisionValues[1]].onclick = createChangingImage(imageDivisionValues[1],profound_personalities[imageDivisionValues[1]].url);
